      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Protein-forward meals and smart carbs to fuel training, recovery,
        ...
        <div className="bg-white rounded-3xl p-10 shadow-sm border border-gray-100">
          ...
          <ul className="space-y-3 text-gray-700">
            <li>✔ High-protein meal options daily</li>
            <li>✔ Balanced carbs timed for training days</li>
            <li>✔ Lean fats for sustained energy</li>
            <li>✔ Add-ons like protein shakes and snacks</li>
          </ul>
        </div>
      </div>
    </section>
